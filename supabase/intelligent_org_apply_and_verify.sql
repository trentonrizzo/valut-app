...
select column_name from information_schema.columns where table_name = 'albums' and column_name = 'parent_album_id';
select to_regclass('public.ai_jobs') as ai_jobs, to_regclass('public.vault_links') as vault_links;
